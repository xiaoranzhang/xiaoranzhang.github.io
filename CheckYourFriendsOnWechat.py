#!/usr/bin/env python
# coding=utf-8
# Thanks for 0x5e's conterbution.
# If you are interested in his works, see the link: https://github.com/0x5e/wechat-deleted-friends
'''
程序原理：
1、连接微信网页版API
2、读取好友列表
3、取出好友组建群聊，每组35人
4、拒绝参与群聊的好友表明，您已经被该好友删除
5、将好友从群聊列表中移出
...
def login():
	...
	# print 'skey: %s, wxsid: %s, wxuin: %s, pa
	# ss_ticket: %s' % (skey, wxsid, wxuin, pass_ticket)
